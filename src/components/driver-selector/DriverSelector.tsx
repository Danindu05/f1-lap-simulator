        ...
        <CardTitle className="text-zinc-100">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {selectedDrivers.length > 0 && (
              <span className="inline-flex items-center gap-3 lg:basis-full lg:mt-1">
                <Badge
                  variant="secondary"
                ...
                <span className="inline-flex items-center gap-3 text-[11px] text-zinc-400">
                  ...
                  <span className="inline-flex items-center gap-1.5">
                    <Badge
                      variant="outline"
                      className="border-purple-400/40 text-purple-300 bg-purple-500/10 text-[10px] px-1 py-0 leading-none h-4 rounded-sm"
                    >
                      FS
                    </Badge>
